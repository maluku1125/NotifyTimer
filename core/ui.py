...
from core.audio import play_text_to_speech, play_ding_sound
...
class TimerApp:
    ...
    def __init__(self, root, version="0.0.0"):
        self.root = root
        self.root.title(f"NotifyTimer - 倒計時提醒 V{version}")
    ...
    def setup_note_tab(self):
        ...
        instructions = [
            ...
            ("原作者", "諭諭"),
            ("Discord", "楓谷玩家歡迎加入TMS新楓之谷 Discord 群!")
        ]
